...
const withWebComponentWrapper = () => WrappedComponent => {
  return class WebComponentWrapper extends HTMLElement {

    mount() {
      const propTypes = WrappedComponent.propTypes ? WrappedComponent.propTypes : {};
      const events = WrappedComponent.propTypes ? WrappedComponent.propTypes : {};
      const props = {
        ...this.getProps(this.attributes, propTypes),
        ...this.getEvents(events),
        children: this.parseHtmlToReact(this.innerHTML)
      };
      render(<WrappedComponent {...props} />, this);
    }
...
export default withWebComponentWrapper;
